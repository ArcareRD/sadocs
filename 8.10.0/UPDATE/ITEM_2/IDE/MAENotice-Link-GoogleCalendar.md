...
* ![pic][image_link_block1]
    ...
    * `(2)標題_給值內容`
        ...
        * 規格說明
            ...
            * 當`(1)標題_類別`=推播來源欄位: [挑選檢視表元件通則][link_ruledialog8], 從 [推播通知_主旨內文: 檢視表][link_conentviewno] 中, 進行檢視表元件挑選, 回傳:檢視表元件. 因查表來源暫不支援個資解密, 故不提供變色處理
    ...
    * `(4)內容_給值內容`
        ...
        * 規格說明
            ...
            * 當`(3)內容_類別`=推播來源欄位: [挑選檢視表元件通則][link_ruledialog8], 從 [推播通知_主旨內文: 檢視表][link_conentviewno] 中, 進行檢視表元件挑選, 回傳:檢視表元件. 因查表來源暫不支援個資解密, 故不提供變色處理
    ...
    * `(6)地點_給值內容`
        ...
        * 規格說明
            ...
            * 當`(5)地點_類別`=推播來源欄位: [挑選檢視表元件通則][link_ruledialog8], 從 [推播通知_主旨內文: 檢視表][link_conentviewno] 中, 進行檢視表元件挑選, 回傳:檢視表元件. 因查表來源暫不支援個資解密, 故不提供變色處理
    ...
    * `(11)日期起`
        ...
        * 規格說明 
            ...
            * 當`(7)替換類別`=推播來源欄位: [挑選檢視表元件通則][link_ruledialog8], 從 [推播通知_主旨內文: 檢視表][link_conentviewno] 中, 進行檢視表元件挑選, 回傳:檢視表元件. 因查表來源暫不支援個資解密, 故不提供變色處理
